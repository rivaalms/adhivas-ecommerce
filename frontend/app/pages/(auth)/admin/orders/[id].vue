...
<template>
   <UPage>
      <UPageHeader
         ...
         description="Informasi rincian pesanan dan update status"
      >
         <template #headline>
            <UButton
      ...
      >
         <!-- Left Column: Customer, Shipping & Status Info -->
         <div class="lg:col-span-2 flex flex-col gap-6">
            <!-- Customer Details Card -->
            <UCard title="Informasi Pelanggan">
               <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                     <span class="block text-xs text-muted">Nama Lengkap</span>
                     <span class="text-highlighted">
                        {{ order.user?.full_name || "-" }}
                     </span>
                  </div>
                  <div>
                     <span class="block text-xs text-muted">Email</span>
                     <span class="text-highlighted">
                        {{ order.user?.email || "-" }}
                     </span>
                  </div>
                  <div>
                     <span class="block text-xs text-muted">Tanggal Pesan</span>
                     <span class="text-highlighted">
